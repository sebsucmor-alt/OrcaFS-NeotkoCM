...
// Upstream Snapmaker #784 (0613c52f0c) / Orca: algunas entidades de soporte llevan caminos
// vacios anidados, y esos no se pueden reordenar sin reventar.
...
{
    // Upstream Snapmaker #784 (0613c52f0c) / Orca: el reordenado pregunta first_point() y
    // last_point(); fuera las entidades que no puedan dar extremos validos. El static_cast de
    // antes asumia que TODA entidad era una ExtrusionEntityCollection, y no lo es.
