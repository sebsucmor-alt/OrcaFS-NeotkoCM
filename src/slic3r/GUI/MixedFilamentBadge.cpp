...
#include "libslic3r/FilamentColorLibrary.hpp"   // Upstream Snapmaker #778 (464d509e87)
                                        ...
                                        const CornerRadius& radius)
{
    ...
    // Upstream Snapmaker #778 (464d509e87): el degradado pasa a ser VERTICAL, de abajo arriba,
    // que es como se ven los filamentos Full Spectrum en la bobina. La clave de cache cambia a
    // "-bt" (bottom-to-top) a proposito, para que los bitmaps cacheados de antes no se reusen.
