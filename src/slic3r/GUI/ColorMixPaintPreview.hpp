// NEOTKO_PROFILE_TAG_START — s233: cálculo del COLOR de la pintura ColorMix
// (ColorStitch / PathBlend / Solid), extraído de GLGizmoColorMixPainter para que lo
...
#ifndef slic3r_GUI_ColorMixPaintPreview_hpp_
#define slic3r_GUI_ColorMixPaintPreview_hpp_
...
// Tabla slot→color del volumen: índice 0 = base sin pintar, 1..COLORMIX_SLOT_COUNT-1 =
...
// los perfiles apuntados. NADA de eso toca el timestamp de color_mix_paint_facets, así
...
// ¿Se debe dibujar la pintura ColorMix en la vista 3D normal? app_config
...
// GLGizmoColorMixPainter.cpp; se mudó aquí SIN cambiar una línea de matemáticas, para
...
// desde mv->color_mix_paint_facets (el gizmo pasa el suyo, vivo; la vista normal
...
#endif // slic3r_GUI_ColorMixPaintPreview_hpp_
