#ifndef slic3r_WaveSupport_hpp_
#define slic3r_WaveSupport_hpp_
// NEOTKO_WAVESUPPORT_TAG_SKELETON — WAVESUPPORT_PLAN.md Fase 2: duplicated from
// Support/SupportMaterial.hpp (Normal/Grid/Snug support engine), not TreeSupport — Tree branches
// optimize for minimal contact (thin tips), which don't give a large flat interface area to build
// a Wave-Huygens roof on. Normal support columns under a flat overhang footprint do. See
// WAVESUPPORT_RESEARCH.md / WAVESUPPORT_PLAN.md §3 for the full rationale.
// Base version: SNAPOFFICIAL SupportMaterial.hpp/.cpp as of 2026-07-10 (this port date) — diff
// against that file to find upstream fixes that may need porting here manually.
...
{
public:
	WaveSupport(const PrintObject *object, const SlicingParameters &slicing_params);
