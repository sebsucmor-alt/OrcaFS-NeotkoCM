...
Moonraker_Mqtt::Moonraker_Mqtt(DynamicPrintConfig* config, bool change_engine) : Moonraker(config) {
    ...
    if (change_engine) {
        ...
        // Upstream Snapmaker #735 (ce37018471): con el MQTT.cpp de la 2.3.6 el constructor ya no
        // lanza (se traga la excepcion y deja client_ a nullptr), pero el new de aqui si puede.
        try {
...
bool Moonraker_Mqtt::connect(wxString& msg, const nlohmann::json& params) {
    ...
    // Upstream Snapmaker #735 (ce37018471).
    try {
