...
std::string ExtrusionEntity::role_to_string(ExtrusionRole role)
{
    switch (role) {
        ...
        case erPenultimateInfill            : return L("Penultimate surface");  // NEOTKO_MULTIPASS_TAG
...
ExtrusionRole ExtrusionEntity::string_to_role(const std::string_view role)
{
    ...
    else if (role == L("Penultimate surface"))  // NEOTKO_MULTIPASS_TAG
        return erPenultimateInfill;
