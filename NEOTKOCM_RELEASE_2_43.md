...
# Neotko FullSpectrum 2.4.3 — on Snapmaker Orca 2.3.5 — Release Notes (draft, in progress)
...
_Nothing yet — 2.4.2 has just shipped and this file is the landing place for whatever comes next._

---

## Notes

_To be filled in as entries land above._
