...
// (ColorStitchPatternDialog, definido file-private en Tab.cpp) desde OTRAS TUs, en
// particular el 3D Painter gizmo (GLGizmoColorStitchPainter). El gizmo no puede ver
...
// varios ColorStitch a distintos Z no se contaminen entre sí.
...
// Abre ColorStitchPatternDialog modal para editar el ColorStitch de UN pase.
...
//   cur_kv  : override ACTUAL del pase (pass.colorstitch.kv). Siembra el diálogo para
...
//             dos ColorStitch en la misma zona difieren de verdad.
