...
#include "libslic3r/NeoArachne/NeoArachneBeadingStrategy.hpp" // NEOTKO_NEOARACHNE_TAG Inc2c
                                                        ...
                                                        const double  neotko_edge_hysteresis_pct)
{
    ...
    // NEOTKO_NEOARACHNE_TAG Inc2c (port s134) — wrap with NeoArachneBeadingStrategy BEFORE Limited
    // (Limited injects 0-width marker walls other strategies shouldn't touch). Pins outer width for
    // bead_count 1/2, caps inner widening, adds spatial hysteresis. No-op when neotko_edge_enabled=false.
