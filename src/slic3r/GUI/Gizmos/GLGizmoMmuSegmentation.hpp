...
private:
    ...
    // el propio gizmo dibuja el preview, con el MISMO patrón que GLGizmoColorStitchPainter::
    ...
    uint64_t m_sw_paint_key   = 0;           // ColorStitchPaintPreview::overlap_key del objeto
