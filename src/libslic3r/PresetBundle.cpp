...
std::vector<FilamentColorMode> LoadFilamentColourModes(const AppConfig &config, const std::string &printerName)
{
    ...
    // Upstream Snapmaker #778 (464d509e87): parsear el numero de verdad en vez de comparar cadenas,
    // y dejar que FilamentColorModeFromConfig decida, que ahora tiene el default invertido.
