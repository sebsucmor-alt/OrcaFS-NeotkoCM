...
public:
    ...
    // (Print.cpp) instead. Default false keeps stock behaviour (M220 S100 reset on every
...
private:
	...
	// every priming/toolchange block (see WipeTower2.cpp toolchange_* / tool_change / priming),
